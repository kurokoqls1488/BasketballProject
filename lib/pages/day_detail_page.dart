...
class _DayDetailPageState extends State<DayDetailPage> {
  ...
  Future<void> _loadExercises() async {
    try {
      ...
      final userProgram = await _authService.getOrCreateUserProgram(widget.programId);
      if (userProgram == null) {
        if (mounted) {
          setState(() {
                           ...
                           Expanded(
                             child: ListView.builder(
                               ...
                               itemBuilder: (context, index) {
                                 ...
                                 final isCompleted = ex['completed'] as bool? ?? false;
                                 final order = ex['exerciseOrder'] as int? ?? index + 1;
                                       ...
                                       child: ListTile(
                                         leading: Container(
                                           ...
                                           decoration: BoxDecoration(
                                             ...
                                             color: isCompleted ? const Color(0xFF4CAF50) : Colors.grey[700],
                                           ),
                                           child: Center(
                                             child: isCompleted
                                         ...
                                         subtitle: Text(
                                           description.isNotEmpty ? LocaleService.translateDbData(description) : '',
                                           style: TextStyle(
                                             color: isCompleted ? Colors.white70 : Colors.white54,
                                             fontSize: 12,
                                           ),
                                           maxLines: 1,
                        ...
                        if (_exercises.isNotEmpty)
                          Padding(
                            ...
                            child: ElevatedButton(
                              ...
                              child: Text(
                                widget.isCompleted ? _t('Review') : _t('Start Training'),
                                style: const TextStyle(
                                  fontSize: 18,
                                  fontWeight: FontWeight.bold,
                                ),

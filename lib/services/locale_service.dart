...
'Ходьба на пятках': 'Heel Walks',
  ...
  static final Map<String, Map<String, String>> _translations = {
    ...
    'Звук и вибрация': {'ru': 'Звук и вибрация', 'en': 'Sound and vibration'},
    'Звуковые эффекты': {'ru': 'Звуковые эффекты', 'en': 'Sound effects'},
    'Воспроизводить звуки при действиях': {
      'ru': 'Воспроизводить звуки при действиях',
      'en': 'Play sounds on actions',
    },
